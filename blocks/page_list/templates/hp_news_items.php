<?php  
	...
	<div class="grid_4 main-content-thumb news-item">
	...
	<?php  
		...
		if (is_object($ts[0])) {
			...
			if(!$thumb->error){ ?>
				...
				<a <?php   if ($target != '') { ?> target="<?php  echo $target?>" <?php   } ?> href="<?php  echo $nh->getLinkToCollection($cobj)?>" style="background-image: url(<?php echo $thumb->getRelativePath(); ?>);"></a></div>
				<?php
			}
		}
	?>
